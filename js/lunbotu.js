$(document).ready(function(){
	...
	if(x == 6) {
		...
		x = 1;
		$iNum.eq(0).addClass('mark-color')
			.siblings()
			.removeClass('mark-color');
	}
	$iBox.animate({
		left: -x * imgSize + 'px'
	}, 300, function() {
		var y = x - 1;
		$iNum.eq(y).addClass('mark-color')
			.siblings()
			.removeClass('mark-color');
    ...
    //向右边前进
    $('.to-right').click(moveImg);
    //向左边前进
    $('.to-left').click(moveImg_r);
